...
### Opstellen digitale verkeerskundige informatie
...
* Het informatiemodel MOET de mogelijkheid bieden om een [=verkeersregel=], [=waarschuwing=] of [=adviessnelheid=] van toepassing te laten zijn op een [=zone=] of een [=werkingsgebied=]:
  * De [=verkeersregel=], [=waarschuwing=] of [=adviessnelheid=] wordt direct aan de wegvakken in de [=zone=] of het [=werkingsgebied=] verbonden.
  * De [=verkeersregel=], [=waarschuwing=] of [=adviessnelheid=] krijgt daarnaast een relatie met de  [=zone=] of het [=werkingsgebied=].
