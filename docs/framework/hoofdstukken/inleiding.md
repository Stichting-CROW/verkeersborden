...
2. Samen met [=KOOP=] wordt gewerkt aan een verkeersbesluiten-applicatie waarmee wegbeheerders hun verkeersbesluit kunnen publiceren als digitale [=verkeerskundige informatie=]
...
#### Verkeersbesluiten
<dfn data-lt="Verkeersbesluit">Verkeersbesluit</dfn>
