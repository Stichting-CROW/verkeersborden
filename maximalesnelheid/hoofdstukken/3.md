...
Zie ook de vertaling in het informatiemodel naar [=RVV1990-InrichtingsType=]

#### Verkeersborden
Hieronder de verkeersborden, waarvan de afwijkende weginrichting door de menselijke weggebruiker wordt herkend:
...
Dit heeft geen invloed op wegtypen maar kan (indien gewenst) wel als informatie worden gepubliceerd in de verkeerskundige informatie om SMART Mobility systemen te ondersteunen. Deze situatie komt deo volente zo weinig voor dat we het nu niet opnemen in deze verkennende beschrijving van het informatiemodel. 
